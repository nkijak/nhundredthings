...
import com.kinnack.nthings.fragments.LevelSelectorFragment;
...
public class WorkoutSettingsActivity extends ActionBarActivity implements LevelSelectorFragment.LevelSelectChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState_) {
        ...
        ((LevelSelectorFragment)getSupportFragmentManager()
                .findFragmentById(R.id.levelSelectorFragment))
            .setLevelSelectorChangeListener(this);
    ...
    private void configureMainView() {
        ...
        ((LevelSelectorFragment)getSupportFragmentManager()
                .findFragmentById(R.id.levelSelectorFragment))
                .setWorkoutController(workoutController);
